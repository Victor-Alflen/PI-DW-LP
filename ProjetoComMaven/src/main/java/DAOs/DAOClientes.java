...
public class DAOClientes extends DAOGenerico<Clientes> {
    ...
    public List<Clientes> listByLogin(String login) {
        return em.createQuery("SELECT e FROM Clientes e WHERE e.login LIKE :login").setParameter("login", login).getResultList();
    }
